...
with open(
    "/Users/sbaio/quran_parsing/data/quran/full_quran.md", "r", encoding="utf-8"
) as f:
    content = f.read()
...
chapters_dir = "/Users/sbaio/quran_parsing/data/quran/chapters/"
...
print("─" * 60)
top10_longest = chapters_df.nlargest(10, "verse_count")[
...
print("─" * 60)
top10_shortest = chapters_df.nsmallest(10, "verse_count")[
    ["chapter_number", "verse_count", "total_word_count"]
]
...
print(
    f'  {longest["text_uthmani"][:200]}...'
    if len(longest["text_uthmani"]) > 200
    else f'  {longest["text_uthmani"]}'
)
